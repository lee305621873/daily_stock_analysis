...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_API_URL": {
        ...
        "description": "Base URL for Tushare Pro API requests.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "TUSHARE_RATE_LIMIT_PER_MINUTE": {
        "title": "Tushare Rate Limit/Min",
        "description": "Client-side per-minute rate limit for Tushare. Set 0 to disable local throttling.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
