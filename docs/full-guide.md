...
| `TUSHARE_API_URL` | Tushare Pro 接口地址，默认 `http://api.tushare.pro`；试用接口可改为自定义域名 | `http://api.tushare.pro` | 可选 |
| `TUSHARE_RATE_LIMIT_PER_MINUTE` | Tushare 本地每分钟限流；设为 `0` 可关闭本地限流 | `80` | 可选 |
